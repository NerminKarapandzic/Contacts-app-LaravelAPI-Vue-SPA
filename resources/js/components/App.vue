<template>
  <div class="h-screen bg-white">
    <div class="flex">
      <div class="bg-gray-200 w-48 h-screen border-r-2 border-gray-400 pl-6">
        <nav class="pt-4">
          <router-link to="/">
            <svg
          ...
          <p class="uppercase text-gray-500 text-xs font-bold pt-12">create</p>
          <router-link to="/contacts/create" class="flex items-center py-2 text-sm">
            ...
            <div class="tracking-wide pl-3 hover:text-blue-500 text-gray-600 font-bold">Add New</div>
          </router-link>

          <p class="uppercase text-gray-500 text-xs font-bold pt-12">general</p>
          <router-link to="/" class="flex items-center py-2 text-sm">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            ...
            <div class="tracking-wide pl-3 hover:text-blue-500 text-gray-600 font-bold">Contacts</div>
          </router-link>
          <router-link to="/" class="flex items-center py-2 text-sm">
            <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-5 h-5">
              <path
            ...
            <div class="tracking-wide pl-3 hover:text-blue-500 text-gray-600 font-bold">Birthdays</div>
          </router-link>

          <p class="uppercase text-gray-500 text-xs font-bold pt-12">settings</p>
          <a href="/logout-manual" class="flex items-center py-2 text-sm">
            <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-5 h-5">
              <path
            ...
            <div class="tracking-wide pl-3 hover:text-blue-500 text-gray-600 font-bold">Logout</div>
          </a>
        </nav>
      </div>
      <!-- Right side menu -->
      <div class="flex flex-col flex-1 overflow-y-hidden h-screen">
        ...
        <div class="h-16 p-6 border-b border-gray-400 flex items-center justify-between">
          <div>Contacts</div>
          <div
            class="rounded-full text-white bg-blue-400 w-10 h-10 flex items-center justify-center border-gray-400"
          >VG</div>
        </div>
        <!-- router view -->
