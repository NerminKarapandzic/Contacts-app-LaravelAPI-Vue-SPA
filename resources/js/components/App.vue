<template>
    <div class="h-screen bg-white">
        <div class="flex">
            <div
                class="bg-gray-200 w-48 h-screen border-r-2 border-gray-400 pl-6"
            >
                <nav class="pt-4">
                    <router-link to="/">
                        <svg
                    ...
                    >
                        ...
                        <div
                            class="tracking-wide pl-3 hover:text-blue-500 text-gray-600 font-bold"
                        >
                            Add New
                        </div>
                    </router-link>
            ...
            <div class="flex flex-col flex-1 overflow-y-hidden h-screen">
                <!-- top side bar -->
                <div
                    class="h-16 p-6 border-b border-gray-400 flex items-center justify-between"
                >
                    <div>Contacts</div>
