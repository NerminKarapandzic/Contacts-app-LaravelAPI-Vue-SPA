...
<div class="h-screen bg-white">
    ...
    <div class="flex">
        <div class="bg-gray-200 w-48 h-screen border-r-2 border-gray-400 pl-6">
            <nav class="pt-4">
                <router-link to="/">
                    <h1 class="fill-current text-blue-600 w-full text-xl font-bold h-12">Factor Company</h1>
                </router-link>

                <p class="uppercase text-gray-500 text-xs font-bold pt-12">
                    Akcije
                </p>
                <router-link to="/contacts/create" class="flex items-center py-2 text-sm">
                    ...
                    <div class="tracking-wide pl-3 hover:text-blue-500 text-gray-600 font-bold">
                        Dodaj novi
                    </div>
                </router-link>
                ...
                <router-link to="/contacts" class="flex items-center py-2 text-sm">
