        ...
        <form method="POST" action="{{ route('register') }}" class="pt-8">
            ...
            <div class="relative">
                <label for="name" class="text-blue-500 text-xs font-bold absolute pl-3 pt-2">Ime i Prezime</label>
                    ...
                    @error('name')
                        <span class="text-red-400 text-sm pt-1" role="alert">
            ...
            <div class="relative pt-3">
                <label for="email" class="text-blue-500 text-xs font-bold absolute pl-3 pt-2 uppercase">e-mail</label>

                    <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" autocomplete="email" placeholder="your@email.com">
            ...
            <div class="relative pt-3">
                <label for="password" class="text-blue-500 text-xs font-bold absolute pl-3 pt-2 uppercase">Password</label>
