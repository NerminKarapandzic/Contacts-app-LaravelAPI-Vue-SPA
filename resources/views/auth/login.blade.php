...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300 ">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <h1 class="text-white text-3xl pt-8">Dobrodošli nazad</h1>
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            ...
            <div class="relative">
                <label for="email" class="text-blue-500 text-xs font-bold absolute pl-3 pt-2">E-MAIL</label>
            ...
            <div class="relative pt-3">
                <label for="password" class="text-blue-500 text-xs font-bold absolute pl-3 pt-2">PASSWORD</label>
